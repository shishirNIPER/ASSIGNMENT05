...
\newline
The given vertices are- \myvec{\pm 13\\0}
\newline
The given vertices are in the form of \myvec{\pm a\\0}

Here, The major axis is along X axis
\newline
The equation of ellipse is of form
$$\frac{x^2}{a^2}+ \frac{y^2}{b^2} = 1$$

Thus, based on the values of vertices and equation form
$$a=13$$

Also, The giver coordinate of foci are \myvec{\pm 5\\0}

We know that foci= \myvec{\pm c\\0}
Thus $$C=5$$
...
Putting values to get equation for given elipse-
